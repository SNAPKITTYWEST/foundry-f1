...
```
DOCUMENT TYPE:        Grantor Retained Annuity Trust (GRAT)
EIN:                  42-6976431
...
This Grantor Retained Annuity Trust Agreement ("Agreement") is entered into as of **July 13, 2026**, by and between:
...
(a) To pursue solutions to the Millennium Prize Problems and related unsolved mathematical problems through formal verification, proof-assistant tooling, and sovereign computational infrastructure;
...
## ARTICLE II — TRUST CORPUS (INITIAL ASSETS)

The Grantor hereby irrevocably transfers to the Trustee the following property to be held, administered, and distributed pursuant to this Agreement:

| Asset | Description | Valuation Basis |
|-------|-------------|-----------------|
| Foundry F1 Source Code | 10-layer Sedona Spine C++/C99/C11 sovereign compute substrate | Fair market value at date of transfer |
| Formal Proofs — Boole | Lean 4.19.0 kernel-verified proof closing Boole's 172-year foundational sorry | Intangible IP — appraised |
| Formal Proofs — GKN I₄ | GKN quartic invariant degree-4 homogeneity proof — first in proof assistant | Intangible IP — appraised |
| Formal Proofs — E₇ | Four E₇ generator symmetries on FTS₅₆ — first in proof assistant | Intangible IP — appraised |
| Sorry Engine Tooling | sledgehammer.py, roster_sweep.py, 1,465 indexed sorry targets | Intangible IP — appraised |
| ALP Closures | 13 CitizenGardens/Foundry sorry closures with prior art timestamps | Intangible IP — appraised |
...
(b) Trust principal if income is insufficient.

**3.4 Annuity Adjustments.** Annuity payments shall not increase by more than 20% per year (per Reg. § 25.2702-3(b)(1)(ii) — stepped annuity permitted).
...
(b) Execute commercial license agreements for any component of the Trust Corpus;

(c) Apply for, prosecute, and maintain patents, copyrights, and trademarks related to the Trust Corpus;

(d) Submit Trust work product to academic journals, conferences, prize committees, and standards bodies;

(e) Accept donations, grants, research funding, and prize awards into the Trust;

(f) Engage attorneys, accountants, and technical experts as needed;

(g) Open and maintain bank accounts and financial instruments in the name of the Trust.

**4.2 Sorry Hunt Mission.** The Trustee is specifically authorized and directed to pursue formal proofs targeting:
- The Riemann Hypothesis (ANT-001)
- The P vs NP Problem
...
|------|----------|-------------|
| Research | Academic non-commercial | Negotiated |
| Commercial | Production deployment | Written agreement required |
...
## ARTICLE VI — SOVEREIGN TRUST AXIOMS
...
## ARTICLE VII — AMENDMENT AND IRREVOCABILITY

**7.1 Irrevocability.** Except as provided in Article III regarding the Grantor's annuity rights, this Trust is irrevocable. The Grantor retains no power to alter, amend, revoke, or terminate this Trust or any of its provisions.

**7.2 Trust Protector.** Ahmad Ali Parr shall serve as Trust Protector with authority to:
(a) Remove and replace the Trustee for cause;
(b) Approve extraordinary transactions above AXIOM-6 threshold;
(c) Interpret ambiguous Trust provisions.
...
## ARTICLE IX — SIGNATURE BLOCK

IN WITNESS WHEREOF, the Grantor and Trustee have executed this Agreement as of the date first written above.
